  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setError(data.error || 'Failed to create demo student')
      }
    } catch (error) {
      setError('Failed to create demo student')
    } finally {
  ...
  return (
    <div className="p-8 max-w-6xl">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Create Demo Student</h1>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={addTaskSubmission} size="sm">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={addRedemptionRequest} size="sm">
                <Plus className="h-4 w-4 mr-2" />
                Add Request
              </Button>
            </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button onClick={addPayout} size="sm">
                <Plus className="h-4 w-4 mr-2" />
                Add Payout
              </Button>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Users Referred by This Student</CardTitle>
          </CardHeader>
          <CardContent>
            {users.length === 0 ? (
              <p className="text-sm text-gray-500 text-center py-4">
